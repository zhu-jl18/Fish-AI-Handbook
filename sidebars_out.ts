...
export const FISH_TALKS_SIDEBAR: SidebarSection = [
  { label: '��˵�ؿ�', href: '/fish-talks' },
  { label: '����', href: '/fish-talks/overview' },
  {
    label: '��ģ�ͳ�ʶ',
    href: '/fish-talks/llm',
    items: [
      { label: 'ģ�ͷ���', href: '/fish-talks/llm/brief' },
      { label: '����ģ��', href: '/fish-talks/llm/models' },
      { label: '��ģ������', href: '/fish-talks/llm/rankings' },
    ],
  },
  {
    label: 'ģ���������',
    ...
    items: [
      { label: 'token', href: '/fish-talks/model-terms/token' },
      { label: '�¶�', href: '/fish-talks/model-terms/temperature' },
      { label: '��ʽ����', href: '/fish-talks/model-terms/streaming' },
      { label: '˼��', href: '/fish-talks/model-terms/thinking' },
      { label: '�����Ĳ���', href: '/fish-talks/model-terms/context-steps' },
    ],
  },
  // ����׼��Ǩ�Ƶ����½� SETUP
  {
    ...
    href: '/fish-talks/advanced-concepts',
    items: [
      { label: 'Agent�������壩', href: '/fish-talks/advanced-concepts/agent' },
      {
        label: 'Vibe Coding����Χ��̣�',
        href: '/fish-talks/advanced-concepts/vibe-coding',
      },
      {
        label: 'Workflow����������',
...
export const BASIC_USAGE_SIDEBAR: SidebarSection = [
  { label: '����ʹ��', href: '/basic-usage' },
  { label: '�ٷ�WebChat', href: '/basic-usage/webchat' },
  { label: '������������������', href: '/basic-usage/app-integration' },
  { label: 'CLI�����й���', href: '/basic-usage/cli' },
  { label: 'AI����༭��', href: '/basic-usage/editor-agent' },
  { label: '�ƶ���AIӦ��', href: '/basic-usage/mobile-apps' },
]

export const PROMPTS_SIDEBAR: SidebarSection = [
  { label: '��ʾ��', href: '/prompts' },
  {
    label: '����֪ʶ',
    href: '/prompts/basics',
    items: [
      { label: '��ʾ�ʻ���', href: '/prompts/basics/intro' },
      { label: '�ṹ��淶', href: '/prompts/basics/structure' },
      { label: 'ע������', href: '/prompts/basics/dos-and-donts' },
    ],
  },
  {
    label: '����ģʽ',
...
export const ADVANCED_TECHNIQUES_SIDEBAR: SidebarSection = [
  {
    ...
    href: '/advanced',
    items: [
      { label: '֪ʶ��', href: '/advanced/knowledge-bases' },
      { label: 'MCP', href: '/advanced/mcp' },
      { label: '��������', href: '/advanced/multi-agent' },
      { label: 'RAG', href: '/advanced/rag' },
      { label: '�������ݿ�', href: '/advanced/vector-databases' },
    ],
  },
]
...
export const TECH_SIDEBAR: SidebarSection = [
  {
    ...
    items: [
      ...
      { label: 'API ����', href: '/tech/api-management' },
...
export const FUN_SIDEBAR: SidebarSection = [
  { label: '�����', href: '/fun' },
  { label: 'AI �滭', href: '/fun/ai-drawing' },
  { label: '��ģ��Խ��', href: '/fun/llm-unlocking' },
  { label: '��ɫ�ƹ�', href: '/fun/silver-trivern' },
]


export const RESOURCES_SIDEBAR: SidebarSection = [
  { label: '��Դ�ϼ�', href: '/resources' },
]
