const id = "03-prompts/advanced-techniques.md";
						const collection = "docs";
						const slug = "03-prompts/advanced-techniques";
						...
						const data = {title:"提示词高级技巧",description:"学习如何运用高级提示技巧，引导模型进行复杂推理。"};
						const _internal = {
							type: 'content',
							filePath: "X:/Projcet/AI BOOK/src/content/docs/03-prompts/advanced-techniques.md",
							rawData: undefined,
						};
