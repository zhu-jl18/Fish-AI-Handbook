const id = "07-fun/llm-unlocking.md";
						const collection = "docs";
						const slug = "07-fun/llm-unlocking";
						...
						const data = {title:"大模型破限教程",description:"安全探索大模型的隐藏潜力，通过创意方式扩展其能力。"};
						const _internal = {
							type: 'content',
							filePath: "X:/Projcet/AI BOOK/src/content/docs/07-fun/llm-unlocking.md",
							rawData: undefined,
						};
