const id = "01-fish-talks/model-terms/token.md";
						const collection = "docs";
						const slug = "01-fish-talks/model-terms/token";
						...
						const data = {title:"token",description:"介绍 token 的定义、长度计算与常见用法"};
						const _internal = {
							type: 'content',
							filePath: "X:/Projcet/AI BOOK/src/content/docs/01-fish-talks/model-terms/token.md",
							rawData: undefined,
						};
