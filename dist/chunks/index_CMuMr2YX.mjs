const id = "04-advanced-techniques/mcp/index.md";
						const collection = "docs";
						const slug = "04-advanced-techniques/mcp";
						...
						const data = {title:"MCP (模型上下文协议)",description:"理解模型上下文协议（MCP）如何为 AI 与外部世界的交互建立标准。"};
						const _internal = {
							type: 'content',
							filePath: "X:/Projcet/AI BOOK/src/content/docs/04-advanced-techniques/mcp/index.md",
							rawData: undefined,
						};
