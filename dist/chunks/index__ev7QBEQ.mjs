const id = "04-advanced-techniques/vector-databases/index.md";
						const collection = "docs";
						const slug = "04-advanced-techniques/vector-databases";
						...
						const data = {title:"向量数据库 (Vector Databases)",description:"了解作为 AI 长期记忆基石的向量数据库是什么，以及它是如何工作的。"};
						const _internal = {
							type: 'content',
							filePath: "X:/Projcet/AI BOOK/src/content/docs/04-advanced-techniques/vector-databases/index.md",
							rawData: undefined,
						};
