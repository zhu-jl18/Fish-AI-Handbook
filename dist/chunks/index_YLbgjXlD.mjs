const id = "04-advanced-techniques/multi-agent/index.md";
						const collection = "docs";
						const slug = "04-advanced-techniques/multi-agent";
						...
						const data = {title:"多智能体 (Multi-Agent)",description:"探索如何让多个独立的 AI 智能体协同工作，以解决复杂问题。"};
						const _internal = {
							type: 'content',
							filePath: "X:/Projcet/AI BOOK/src/content/docs/04-advanced-techniques/multi-agent/index.md",
							rawData: undefined,
						};
