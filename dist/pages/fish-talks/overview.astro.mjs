...
const $$Overview = createComponent(($$result, $$props, $$slots) => {
  ...
  <a href="/fish-talks/overview" class="active">Overview</a>
  <div>
...
`;
  const headings = [
    { id: "intro", text: "Fish\u60F3\u8BF4 \xB7 \u6982\u89C8", depth: 1 }
  ];
  return renderTemplate`${renderComponent($$result, "ContentLayout", $$ContentLayout, { "title": "Fish\u60F3\u8BF4 - \u6982\u89C8", "section": "Fish\u60F3\u8BF4", "sidebarContent": sidebarContent, "sidebarItems": FISH_TALKS_SIDEBAR, "headings": headings }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h1 id="intro">Fish想说 · 概览</h1> <p>此处将作为“Fish想说”模块的总体概览（占位）。</p> ` })}`;
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/overview.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/overview.astro";
const $$url = "/fish-talks/overview";
