...
const $$Streaming = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/model-terms/streaming");
  ...
  <div>
    ...
    <div class="submenu">
      ...
      <a href="/fish-talks/model-terms/streaming" class="active">\u6D41\u5F0F\u4F20\u8F93</a>
...
`;
  const headings = [
    { id: "streaming", text: "\u4EC0\u4E48\u662F\u6D41\u5F0F\u4F20\u8F93\uFF08Streaming\uFF09", depth: 1 },
    { id: "benefit", text: "\u4E3A\u4EC0\u4E48\u8981\u7528\u6D41\u5F0F", depth: 2 },
    { id: "protocols", text: "\u5E38\u89C1\u5B9E\u73B0\u65B9\u5F0F", depth: 2 },
    { id: "frontend", text: "\u524D\u7AEF\u6E32\u67D3\u4E0E\u7528\u6237\u4F53\u9A8C", depth: 2 },
    { id: "server", text: "\u540E\u7AEF\u5B9E\u73B0\u8981\u70B9", depth: 2 }
  ];
...
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/model-terms/streaming.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/model-terms/streaming.astro";
const $$url = "/fish-talks/model-terms/streaming";
