...
const $$ContextSteps = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/model-terms/context-steps");
  ...
  <div>
    ...
    <div class="submenu">
      ...
      <a href="/fish-talks/model-terms/context-steps" class="active">\u4E0A\u4E0B\u6587\u6B65\u6570</a>
    </div>
  </div>
  <div>
...
`;
  const headings = [
    { id: "context-steps", text: "\u4E0A\u4E0B\u6587\u6B65\u6570", depth: 1 }
  ];
...
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/model-terms/context-steps.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/model-terms/context-steps.astro";
const $$url = "/fish-talks/model-terms/context-steps";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$ContextSteps,
  file: $$file,
  url: $$url
