...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/preparations/index");
...
`;
  const headings = [
    { id: "\u4E3A\u4EC0\u4E48\u5148\u505A\u73AF\u5883\u51C6\u5907", text: "\u4E3A\u4EC0\u4E48\u5148\u505A\u73AF\u5883\u51C6\u5907", depth: 1 }
  ];
  return renderTemplate`${renderComponent($$result, "ContentLayout", $$ContentLayout, { "title": `Fish\u60F3\u8BF4 - \u73AF\u5883\u51C6\u5907 / \u6982\u89C8`, "section": "Fish\u60F3\u8BF4", "sidebarContent": sidebarContent, "sidebarItems": FISH_TALKS_SIDEBAR, "headings": headings }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/preparations/index.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/preparations/index.astro";
const $$url = "/fish-talks/preparations";
