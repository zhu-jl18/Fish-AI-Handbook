...
const $$Env = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/glossary/env");
  ...
  <div>
    ...
    <div class="submenu">
      ...
      <a href="/fish-talks/glossary/env" class="active">\u73AF\u5883\u53D8\u91CF</a>
    </div>
  </div>
`;
  const headings = [
    { id: "\u4E3A\u4EC0\u4E48\u8981\u7528\u73AF\u5883\u53D8\u91CF", text: "\u4E3A\u4EC0\u4E48\u8981\u7528\u73AF\u5883\u53D8\u91CF", depth: 1 }
  ];
...
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/glossary/env.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/glossary/env.astro";
const $$url = "/fish-talks/glossary/env";
