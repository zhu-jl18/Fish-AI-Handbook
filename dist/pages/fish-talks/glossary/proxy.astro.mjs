...
const $$Proxy = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/glossary/proxy");
  ...
  <div>
    ...
    <div class="submenu">
      ...
      <a href="/fish-talks/glossary/proxy" class="active">\u4EE3\u7406</a>
...
`;
  const headings = [
    { id: "\u4E3A\u4EC0\u4E48\u8981\u61C2\u4EE3\u7406", text: "\u4E3A\u4EC0\u4E48\u8981\u61C2\u4EE3\u7406", depth: 1 }
  ];
...
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/glossary/proxy.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/glossary/proxy.astro";
const $$url = "/fish-talks/glossary/proxy";
