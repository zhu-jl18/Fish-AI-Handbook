...
const $$Interface = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/glossary/interface");
  ...
  <div>
    ...
    <div class="submenu">
      ...
      <a href="/fish-talks/glossary/interface" class="active">\u63A5\u53E3</a>
      <a href="/fish-talks/glossary/env">\u73AF\u5883\u53D8\u91CF</a>
    </div>
  </div>
`;
  const headings = [
    { id: "\u4E3A\u4EC0\u4E48\u8981\u61C2\u63A5\u53E3", text: "\u4E3A\u4EC0\u4E48\u8981\u61C2\u63A5\u53E3", depth: 1 }
  ];
...
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/glossary/interface.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/glossary/interface.astro";
const $$url = "/fish-talks/glossary/interface";
