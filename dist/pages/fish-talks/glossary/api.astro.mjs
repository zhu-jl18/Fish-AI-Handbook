...
const $$Api = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/glossary/api");
  ...
  <div>
    ...
    <div class="submenu">
      <a href="/fish-talks/glossary/api" class="active">API</a>
...
`;
  const headings = [
    { id: "\u4E3A\u4EC0\u4E48\u8981\u61C2-api", text: "\u4E3A\u4EC0\u4E48\u8981\u61C2 API", depth: 1 }
  ];
...
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/glossary/api.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/glossary/api.astro";
const $$url = "/fish-talks/glossary/api";
