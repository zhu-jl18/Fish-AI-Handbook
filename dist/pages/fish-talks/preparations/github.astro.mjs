...
const $$Github = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/preparations/github");
  ...
  <div>
    ...
    <div class="submenu">
      ...
      <a href="/fish-talks/preparations/github" class="active">GitHub</a>
...
`;
  ...
  return renderTemplate`${renderComponent($$result, "ContentLayout", $$ContentLayout, { "title": `Fish\u60F3\u8BF4 - \u73AF\u5883\u51C6\u5907 / GitHub`, "section": "Fish\u60F3\u8BF4", "sidebarContent": sidebarContent, "sidebarItems": FISH_TALKS_SIDEBAR, "headings": headings }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/preparations/github.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/preparations/github.astro";
const $$url = "/fish-talks/preparations/github";
