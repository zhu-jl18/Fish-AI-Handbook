...
const $$Workflow = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/advanced-concepts/workflow");
  ...
  <div>
    ...
    <div class="submenu">
      ...
      <a href="/fish-talks/advanced-concepts/workflow" class="active">Workflow\uFF08\u5DE5\u4F5C\u6D41\uFF09</a>
    </div>
  </div>
`;
  const headings = [
  ...
  return renderTemplate`${renderComponent($$result, "ContentLayout", $$ContentLayout, { "title": `Fish\u60F3\u8BF4 - \u8FDB\u9636\u6982\u5FF5 / Workflow\uFF08\u5DE5\u4F5C\u6D41\uFF09`, "section": "Fish\u60F3\u8BF4", "sidebarContent": sidebarContent, "sidebarItems": FISH_TALKS_SIDEBAR, "headings": headings }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/advanced-concepts/workflow.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/advanced-concepts/workflow.astro";
const $$url = "/fish-talks/advanced-concepts/workflow";
