...
const $$Agent = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/advanced-concepts/agent");
  ...
  <div>
    ...
    <div class="submenu">
      <a href="/fish-talks/advanced-concepts/agent" class="active">Agent\uFF08\u667A\u80FD\u4F53\uFF09</a>
...
`;
  ...
  return renderTemplate`${renderComponent($$result, "ContentLayout", $$ContentLayout, { "title": `Fish\u60F3\u8BF4 - \u8FDB\u9636\u6982\u5FF5 / Agent\uFF08\u667A\u80FD\u4F53\uFF09`, "section": "Fish\u60F3\u8BF4", "sidebarContent": sidebarContent, "sidebarItems": FISH_TALKS_SIDEBAR, "headings": headings }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/advanced-concepts/agent.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/advanced-concepts/agent.astro";
const $$url = "/fish-talks/advanced-concepts/agent";
