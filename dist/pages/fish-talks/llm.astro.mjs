...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  const entry = await getEntry("docs", "01-fish-talks/llm/index");
...
`;
  const headings = [
    { id: "\u4F60\u4F1A\u4E86\u89E3", text: "\u4F60\u4F1A\u4E86\u89E3", depth: 1 }
  ];
  return renderTemplate`${renderComponent($$result, "ContentLayout", $$ContentLayout, { "title": "Fish\u60F3\u8BF4 - \u5927\u6A21\u578B\u5E38\u8BC6", "section": "Fish\u60F3\u8BF4", "sidebarContent": sidebarContent, "sidebarItems": FISH_TALKS_SIDEBAR, "headings": headings }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "X:/Projcet/AI BOOK/src/pages/fish-talks/llm/index.astro", void 0);

const $$file = "X:/Projcet/AI BOOK/src/pages/fish-talks/llm/index.astro";
const $$url = "/fish-talks/llm";
