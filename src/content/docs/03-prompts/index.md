...
首先要澄清一个误区：:mark[Prompt Engineering 不是在那念咒语]{c=red}。
有太多所谓的 "God Mode Prompt" ，试图让你相信只要复制粘贴一段神秘文字，LLM 就能瞬间从人工智障变成爱因斯坦，你信吗？
Prompt Engineering 的本质非常无聊，它只有两件事：
1.  Instruction Design ：向模型用逻辑清晰的语言把任务描述清楚。
2.  Context Management ：尽量控制模型的上下文窗口是有用的信息。
