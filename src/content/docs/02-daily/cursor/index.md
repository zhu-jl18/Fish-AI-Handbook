...
<!-- 图片占位：Cursor AI设置面板截图 -->
<img src="" width="85%">
<!-- 图说：Settings → AI面板，展示模型选择(Claude 3.5 Sonnet vs Haiku)和配置选项 -->
...
<!-- 图片占位：Cursor三种交互模式对比图 -->
<img src="" width="100%">
<!-- 图说：左(行内补全Tab)|中(/edit选区编辑)|右(Chat/Composer侧边对话)三种模式的适用场景对比 -->
...
<!-- 图片占位：Cursor diff确认界面截图 -->
<img src="" width="95%">
<!-- 图说：展示改动diff界面，标注"禁用自动保存，先看diff再接受"的最佳实践 -->

<!-- 图片占位：Cursor与Claude Code选择决策流程图 -->
<img src="" width="90%">
<!-- 图说：决策树：大范围扫描/并行审查/强Hook → Claude Code；IDE内即刻修改/小批量补全 → Cursor -->
